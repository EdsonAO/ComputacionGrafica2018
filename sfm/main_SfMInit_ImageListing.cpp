...
int main(int argc, char **argv)
{
  ...
  std::cout << " Datos : " <<std::endl
            << argv[0] << std::endl
            << "--Directorio de Imagenes " << sImageDir << std::endl
            << "--BasedeDatosdeSensores " << sfileDatabase << std::endl
            << "--Directorio de Salida " << sOutputDir << std::endl
            << "--focal " << focal_pixels << std::endl
            << "--intrinsics " << sKmatrix << std::endl
            << "--Modelo de Camara " << i_User_camera_model << std::endl
            << "--Grupo de Camara " << b_Group_camera_model << std::endl;
  ...
  std::cout << std::endl
    << "SfMInit_ImageListing reporte:\n"
    << "Imagenes procesadas: " << vec_image.size() << "\n"
    << "Imagenes usables en sfm_data: " << sfm_data.GetViews().size() << "\n"
    << "Intrinsics usables en sfm_data: " << sfm_data.GetIntrinsics().size() << std::endl;
